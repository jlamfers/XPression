...
{
   public class QuerySyntax<TExtender> : BaseSyntax<TExtender> where TExtender : new()
   {

      public static readonly QuerySyntax<TExtender> Instance = new QuerySyntax<TExtender>();
